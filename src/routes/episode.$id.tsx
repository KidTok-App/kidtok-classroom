...
export const Route = createFileRoute("/episode/$id")({
  head: ({ params }) => {
    ...
    const title = `Cartoon ${shortId} — KidTok Classroom`;
    const description = `Watch this custom AI-generated educational cartoon (episode ${shortId}) made for kids ages 5–8 by the KidTok Classroom multi-agent pipeline.`;
    const url = `https://kidtokai.com/episode/${params.id}`;
    return {
      meta: [
        { title },
      ...
      scripts: [
        {
          ...
          children: JSON.stringify({
            ...
            description,
            url,
            educationalLevel: "Kindergarten through Grade 3",
            audience: { "@type": "EducationalAudience", educationalRole: "student" },
            typicalAgeRange: "5-8",
            learningResourceType: "Animated cartoon",
            isAccessibleForFree: true,
            provider: { "@type": "Organization", name: "KidTok Classroom", url: "https://kidtokai.com" },
          }),
        },
      ],
    };
